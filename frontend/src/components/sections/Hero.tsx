    ...
    return <section className="relative pt-32 lg:pt-36">
        <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
            <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-0">
                ...
                ></span>
                <span className="absolute right-4 bottom-12 sm:right-8 sm:bottom-16 w-16 h-16 sm:w-24 sm:h-24 rounded-3xl bg-primary blur-xl opacity-80"></span>
            </div>
            ...
            <div className="relative flex flex-col items-center text-center lg:text-left lg:py-8 lg:items-start 
                ...
                <h1 className="text-heading-1 text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-violet-600 ml-2"
                        style={{ textShadow: "0 0 10px rgba(124, 58, 237, 0.5)" }}>Reward</span>{' '}
                    yourself and keep yourself{' '}
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-violet-600 ml-2"
                        style={{ textShadow: "0 0 10px rgba(124, 58, 237, 0.5)" }}>accountable.</span>
                </h1>
                <Paragraph className="mt-8">
                    Stay focused, stay motivated. Our app helps you power through your tasks
                    —so you can earn your way back to what you love most:{' '}
                    <span className="text-white font-bold text-lg">Gaming.</span>
                </Paragraph>
                            ...
                            <span className="min-w-max pr-2 border-r border-box-border">
                                ...
                                >
                                    <path
                                        ...
                                        2.25 0 001.183 1.981l6.478 3.488m8.839 2.51l-4.66-2.51m0 0l-1.023-.55a2.25 
                                        2.25 0 00-2.134 0l-1.022.55m0 0l-4.661 2.51m16.5 1.615a2.25 2.25 0 01-2.25 
            ...
            <div className="flex flex01 lg:w-1/2 lg:h-auto relative lg:max-w-none lg:mx-0 mx-auto max-w-3xl">
                <img src={image1} alt="First Landing Page" className="lg:absolute lg:w-full lg:h-full rounded-3xl 
