                ...
                <nav className="w-full flex justify-between gap-6 relative">
                    ...
                    <div className="min-w-max inline-flex relative">
                        <a href="/" className="relative flex items-center gap-1">
                            <img src={logo} alt="FocusForge Logo" className="w-20 h-15" />
                            <div className="inline-flex text-2xl font-semibold leading-none text-heading-1">
                                FocusForge
                            </div>
                        </a>
                    </div>
                    ...
                    <div className="min-w-max flex items-center gap-x-3">
                        <button 
                            ...
                            className="outline-hidden flex relative text-heading-2 rounded-full p-2 
                                           lg:p-3 border border-box-border cursor-pointer transform transition 
                                           duration-300 hover:scale-85"
                        >
                            {theme === "dark" ? (
                                <svg
